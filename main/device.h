...
/* Get media count */
extern 
RESULT optcl_device_get_media_count(const optcl_device *device, uint32_t *count);

/* Get media info */
extern 
RESULT optcl_device_get_media_info(const optcl_device *device,
...
/* Get product string */
extern 
RESULT optcl_device_get_product(const optcl_device *device,
                                char **product);

/* Get revision string */
extern 
RESULT optcl_device_get_revision(const optcl_device *device,
                                 char **revision);

/* Get device type */
extern 
RESULT optcl_device_get_type(const optcl_device *device,
                             uint16_t *type);

/* Get device vendor */
extern 
RESULT optcl_device_get_vendor(const optcl_device *device,
                               char **vendor);
