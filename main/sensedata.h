...
#define E_SENSE_CFM_IM_2	MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x30, 0x06)

/* Cannot format medium - incompatible medium */
#define E_SENSE_CFM_IM_5	MAKE_SENSE_ERRORCODE(SENSEDATA_SK_ILLEGAL_REQUEST, 0x30, 0x06)

/* Cleaning failure */
#define E_SENSE_CF_2		MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x30, 0x07)
...
#define E_SENSE_CWM_UMV_2	MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x30, 0x11)

/* Cannot write medium - unsupported medium version */
#define E_SENSE_CWM_UMV_5	MAKE_SENSE_ERRORCODE(SENSEDATA_SK_ILLEGAL_REQUEST, 0x30, 0x11)

/* Medium not present */
#define E_SENSE_MNP		MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x3A, 0x00)

/* Medium not present - tray closed */
#define E_SENSE_MNP_TC		MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x3A, 0x01)

/* Medium not present - tray open */
#define E_SENSE_MNP_TO		MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x3A, 0x02)

/* Logical unit has not self-configured yet */
#define E_SENSE_LUHNSCY		MAKE_SENSE_ERRORCODE(SENSEDATA_SK_NOT_READY, 0x3E, 0x00)
